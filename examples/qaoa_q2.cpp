...
// -lhqcl $HQ/examples/qaoa_q2.cpp $ ./qaoa_q2
//
...
//    2.1992e+02
//    2.5022e+01
// Simulated Annealing (SA) execution count: 28710
// Total energy using Simulated Annealing (SA): -0.5
//
...
quantum_kernel void qaoaQ2() {
  ...
  // Z0Z1
  RZ(QubitReg[0], QuantumVariableParams[Index + 1]);
...
int main() {
  ...
  // Starting parameters - size is number of layers * 2
